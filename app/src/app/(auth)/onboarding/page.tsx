...
const selectCls = 'flex h-12 w-full rounded-lg border border-zinc-700 bg-zinc-800 px-3 py-2 text-base text-zinc-100 focus:border-pilot-lime focus:outline-none focus:ring-1 focus:ring-pilot-lime transition-colors';
...
export default function OnboardingPage() {
  ...
  useEffect(() => {
    if (data.telefono.length >= 9 && step === 0) {
      // Podríamos recuperar borrador aquí si hiciera falta
    }
  }, [data.telefono, step]);
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="mb-6">
          <div className="flex justify-between text-xs text-zinc-500 mb-2">
            ...
            <span className="text-pilot-lime font-semibold">{STEPS[step]}</span>
          </div>
          <div className="h-1 rounded-full bg-zinc-800">
            <div
              className="h-1 rounded-full bg-pilot-lime transition-all duration-300 shadow-[0_0_8px_rgba(141,198,63,0.4)]"
        ...
        <Card className="border-zinc-800 bg-zinc-900">
          <form onSubmit={(e) => { e.preventDefault(); step === STEPS.length - 1 ? handleComplete(e) : handleNext(); }}>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <select className={selectCls} value={data.tipo_combustible} onChange={(e) => set('tipo_combustible', e.target.value)}>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select className={selectCls} value={data.tipo_transmision} onChange={(e) => set('tipo_transmision', e.target.value)}>
            ...
            {step === 2 && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" size="sm" variant="outline" onClick={addAsalariado} className="gap-1 border-pilot-lime/30 text-pilot-lime hover:bg-pilot-lime/10">
                ...
                <div className="space-y-3 max-h-[400px] overflow-y-auto pr-1">
                  {data.asalariados.length === 0 ? (
                    <div className="rounded-xl border border-zinc-800 bg-zinc-800/40 p-10 text-center">
                      <Users className="mx-auto h-10 w-10 text-zinc-700 mb-3" />
                    ...
                    data.asalariados.map((a, i) => (
                      <div key={i} className="relative rounded-xl border border-zinc-800 bg-zinc-800/60 p-4 space-y-4">
                        <button
                          type="button"
                        ...
                        <div className="grid grid-cols-2 gap-4 items-end bg-black/20 p-3 rounded-lg border border-zinc-800/50">
                          <div className="space-y-1.5">
                            ...
                            <select
                              className="h-9 w-full rounded-md border border-zinc-700 bg-zinc-900 px-2 text-xs text-zinc-100 focus:border-pilot-lime focus:outline-none"
            ...
            {step === 3 && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" size="sm" variant="outline" onClick={addGasto} className="gap-1 border-zinc-700 text-zinc-400 hover:bg-zinc-800">
                    <Plus className="h-4 w-4" /> Añadir
                  </Button>
                </div>
                ...
                <div className="space-y-3 max-h-[400px] overflow-y-auto pr-1 font-mono">
                  {data.gastos_fijos.length === 0 ? (
                    <div className="rounded-xl border border-zinc-800 bg-zinc-800/40 p-10 text-center font-sans">
                      <Wallet className="mx-auto h-10 w-10 text-zinc-700 mb-3" />
                    ...
                    data.gastos_fijos.map((g, i) => (
                      <div key={i} className="relative rounded-xl border border-zinc-800 bg-zinc-800/60 p-4">
                        <button
                          type="button"
                        ...
                        <div className="grid grid-cols-12 gap-3 items-center">
                          ...
                          <div className="col-span-6 md:col-span-3">
                            <select
                              className="h-9 w-full rounded border border-zinc-700 bg-zinc-900 px-1 text-center text-[10px] text-zinc-100 focus:border-pilot-lime focus:outline-none"
            ...
            {step === 4 && (
              <div className="space-y-4">
                ...
                <div className="space-y-4 text-xs max-h-[450px] overflow-y-auto pr-1">
                  ...
                  <div className="p-4 rounded-xl bg-zinc-800/60 border border-zinc-700 space-y-3">
                    <div className="flex items-center gap-2 text-pilot-lime font-black uppercase tracking-[0.2em] text-[9px] mb-1">
                  ...
                  <div className="p-4 rounded-xl bg-zinc-800/60 border border-zinc-700 space-y-3">
                    <div className="flex items-center gap-2 text-blue-400 font-black uppercase tracking-[0.2em] text-[9px] mb-1">
                  ...
                  {data.asalariados.length > 0 && (
                    <div className="p-4 rounded-xl bg-zinc-800/60 border border-emerald-900/30 space-y-3">
                      <div className="flex items-center gap-2 text-emerald-400 font-black uppercase tracking-[0.2em] text-[9px] mb-1">
                      ...
                      {data.asalariados.map((a, i) => (
                        <div key={i} className="flex justify-between items-center py-2 border-b last:border-0 border-zinc-800">
                          ...
                          <span className="bg-emerald-500/10 text-emerald-400 px-2 py-1 rounded text-[10px] font-mono font-bold">
                  ...
                  {data.gastos_fijos.length > 0 && (
                    <div className="p-4 rounded-xl bg-zinc-800/60 border border-red-900/30 space-y-3">
                      <div className="flex items-center gap-2 text-red-400 font-black uppercase tracking-[0.2em] text-[9px] mb-1">
            ...
            <div className="mt-8 flex justify-between gap-4">
              {step > 0 ? (
                <Button type="button" variant="outline" className="border-zinc-700 text-zinc-400" onClick={() => setStep((s) => s - 1)}>
